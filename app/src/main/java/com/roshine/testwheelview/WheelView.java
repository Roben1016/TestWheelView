...
//			0xcfE9E9E9, 0x3fE9E9E9 };
	private int[] SHADOWS_COLORS = new int[] { getResources().getColor(R.color.white_alphe),
			getResources().getColor(R.color.white_alphe), getResources().getColor(R.color.white_alphe) };
//	private int[] SHADOWS_COLORS = new int[] { getResources().getColor(R.color.red),
//			getResources().getColor(R.color.green), getResources().getColor(R.color.yellow) };
//	private int[] SHADOWS_COLORS = new int[] { Color.WHITE,
